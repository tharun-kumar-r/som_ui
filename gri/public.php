...
//dump data and sent mail
    ...
    function uplad($dat,$emai,$nam,$add,$su,$de,$no,$date,$co,$mai,$clgnam,$f,$admi,$te)
    {
      
        $query =  mysqli_query($co,"insert into publi_c (email, name, mobile, regno, subject, des, filename, data, data1) 
        values('$emai','$nam','$te','$add','$su','$de','$dat','$no','$date')");       
        if($query == true)
        {
...
//end of function
    ...
    {
        //file check
        uplad($file,$email,$sname,$address,$sub,$dec,$now,$datec,$con,$mail,$clgname,$fl,$admin,$tel);
    ...
    {
         uplad($filename,$email,$sname,$address,$sub,$dec,$now,$datec,$con,$mail,$clgname,$fl,$admin,$tel);
...
<font class="sign">Public Grievance Form</font>
</div>
<div style="margin:10px;">
...
<div style="margin:10px;">
<div class="fx">Address<Font color="red"> *</font></div>
<textarea style="resize:none;padding-top:12px;padding-bottom:16px;" placeholder="Address, Pin-code etc  " class="ginput" rows="4" type="text" name="address" required></textarea>
</div>
</div>
