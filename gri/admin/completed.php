...
SELECT id,dept,status,subject,des,data,data1,name,type,email,mobile,regno,filename,sem FROM publi_c WHERE status='completed' ORDER BY data1 DESC"; 
}
else
{
  $sql = "SELECT id,dept,status,subject,des,data,data1,name,type,email,mobile,regno,filename,sem FROM staff  WHERE status='completed' UNION ALL
...
{
  $screen .= '<tr><td>'. '<br><center><font color="#dc3545">No Completed Grievances Found!.</font></center><br>' . '</td></tr>';
}
          ...
          <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb adminx-page-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Completed Grievances</li>
              </ol>
            </nav>

            <div class="pb-3">
              <h1>Completed Grievances</h1>
            </div>
...
window.history.replaceState('1','th',url.toString());
   ...
   " checked> Send mail about this action</label>
     ...
     <form method="POST">
     <button class="xbtn" name="mov1">Move to inprogress</button>
     </form>
     <form method="POST">
