(function (b) {
    b(function () {
        b.widget("blk.hpaging", {
            options: { limit: 5, activePage: 1, parentID: "1", navBar: null, totalPages: ""}, _create: function () { var a = this._getNavBar(); b(this.element).after(a) }, _getNavBar: function () { var a; a = b(this.element).prop("id"); this.options.parentID = a; a = b("<div style=overflow:auto;padding:5px id=pg_" + a + ">").addClass("pagination").data("parentID", a); this.options.navBar = a; this.setPages(this.options.activePage); return a }, clearPages: function () {
                ...
                var c = !1; if (this.clearPages()) {
                    var c = this.options.limit, h = b("#" + this.options.parentID + " > tbody > tr"), f, d = h.length / c; f = d; d = d.toString().split("."); 2 == d.length && (f = parseInt(d[0]) + 1); 0 == f && (f = 1); d =
                        this.options.parentID;  this._setPage(d, "P-1", "Back"); for (var g = 0, k = c, e, l = 1; l <= f; l++)g = h.slice(g, k), e = l, b(g).removeData("page"), b(g).data("page", e), this._setPage(d, e, e), g = k, k = parseInt(k) + parseInt(c); this._setPage(d, "P+1", "Next");  this.options.totalPages = e; void 0 !== a && this.activePage(a); c = !0
                } return c
            ...
            }, _selectActivePage:function () { var a = this.options.activePage; b(this.options.navBar).find("a").each(function () { var c = b(this).text(); b(this).data("page") == a && "<<" != c && ">>" != c && (b(this).attr("class", "ac"), b(this).siblings().attr("class", "ho")) }) }, onPageClick: function (a) {
