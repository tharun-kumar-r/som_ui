...
if($fil == "pending") 
{
$sql = "SELECT * FROM `student` WHERE STATUS='pending' ORDER BY id ASC"; 
}
if($fil == "inprogress") 
{
$sql = "SELECT * FROM `student` WHERE STATUS='inprogress' ORDER BY id ASC"; 
}
if($fil == "completed") 
{
$sql = "SELECT * FROM `student` WHERE STATUS='completed' ORDER BY id ASC"; 
}
