...
if($fil == "pending") 
{
$sql = "SELECT * FROM `publi_c` WHERE STATUS='pending' ORDER BY id ASC"; 
}
if($fil == "inprogress") 
{
$sql = "SELECT * FROM `publi_c` WHERE STATUS='inprogress' ORDER BY id ASC"; 
}
if($fil == "completed") 
{
$sql = "SELECT * FROM `publi_c` WHERE STATUS='completed' ORDER BY id ASC"; 
}

if($fil == "") 
{
$sql = "SELECT * FROM `publi_c` ORDER BY id DESC"; 
}
...
if($fil == "old") 
{
  $sql = "SELECT * FROM `publi_c` ORDER BY id ASC"; 
}
